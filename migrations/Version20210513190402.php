 ...
 */
final class Version20210513190402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, station_id INT DEFAULT NULL, order_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, amount INT NOT NULL, INDEX IDX_D338D58321BDB235 (station_id), INDEX IDX_D338D5838D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT NOT NULL, start_location_id INT NOT NULL, end_location_id INT NOT NULL, transport_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, INDEX IDX_F52993985C3A313A (start_location_id), INDEX IDX_F5299398C43C7F1 (end_location_id), UNIQUE INDEX UNIQ_F52993989909C13F (transport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transport (id INT AUTO_INCREMENT NOT NULL, station_id INT DEFAULT NULL, INDEX IDX_66AB212E21BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993989909C13F FOREIGN KEY (transport_id) REFERENCES transport (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F52993989909C13F');
