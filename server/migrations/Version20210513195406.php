 ...
 */
final class Version20210513195406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, name VARCHAR(255) NOT NULL, amount INT NOT NULL, INDEX IDX_D338D58364D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transport (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, INDEX IDX_66AB212E64D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE transport ADD CONSTRAINT FK_66AB212E64D218E FOREIGN KEY (location_id) REFERENCES location (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transport DROP FOREIGN KEY FK_66AB212E64D218E');
